...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      stepRich([{ t: 'Two upload entries appear. ' }, { t: 'AI Scanning', ui: true },
                { t: ' reads and classifies the document automatically — it covers around 40 document types. ' },
                { t: 'Non AI Scanning', ui: true }, { t: ' stores anything else as-is.' }]),
      stepRich([{ t: 'Not sure which entry a document belongs to? Click ' }, { t: '+35 more', ui: true },
                { t: ' and search for it. The list says which entry each type goes to.' }]),
